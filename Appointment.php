...
<nav class="navbar navbar-expand-lg navbar-dark" style="background-color: grey;">
  ...
  <br><br>
  <a href="cancelled.php"><button class="btn btn-danger">Cancel Appointment</button></a>
    <table class="table table-striped">
      ...
      <?php
        ...
        $sql="SELECT * from appointment where AppointStatus='confirmed'";
 ...
 //echo"<td> <button class='btn btn-info'><a href=\"confirmed.php?id=$id\"' onclick='return confirm(\"Do you want to confirmed this Appointment\")'>CONFIRMED</button></a></td>";
